function [labels] = runBuildPyramidOnImages(parentDir, directory,imgCount)
...
%--------------------------------------------------------------------------
    ...
    outDir=strcat(parentDir,'/img',datestr(now,'mmddyyyy_HHMMSSFFF'));
    mkdir(outDir);
    results = BuildPyramidLLC(imgTrain, directory, outDir);
